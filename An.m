...
a1 = mu .* m.^2 .* sphbes(n,m.*x,'j') .* (sphbes(n,x,'j')+ x .* dsphbes(n,x,'j'));
a2 = mu1 .* sphbes(n,x,'j') .*(sphbes(n,m.*x,'j') + x .* m.*dsphbes(n,m.*x,'j') );
a3 = mu .* m.^2 .* sphbes(n,m.*x,'j') .* (sphbes(n,x,'h') + x.* dsphbes(n,x,'h'));
a4 = mu1 .* sphbes(n,x,'h') .* (sphbes(n,m.*x,'j') + x.*m.*dsphbes(n,m.*x,'j'));
an = (a1-a2)./(a3-a4);
